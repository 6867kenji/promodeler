...
架空の日本人成人、21歳、裸足164cm。白い中厚空手着上下、白帯、不透明な白スポーツインナー、裸足。

ID `karate-student` / category `female-character` / kind `humanoid` / 設計レビュー
...
```json
{
  ...
  "sex": "female",
  "age": 21,
  "face_shape_hair": "黒髪を高めの束ね髪、若い成人の顔、引き締まった体格",
  "outfit_palette": "白い中厚空手着上下、白帯、不透明な白スポーツインナー、裸足"
}
```

## 外観

黒髪を高めの束ね髪、若い成人の顔、引き締まった体格

## 身体寸法

```json
{
  "barefoot_height_m": 1.64,
  "standing_shod_height_m": 1.64,
  "shoe_sole_m": 0,
  "age": 21,
  "shoulder_width_m": 0.385,
  "inseam_m": 0.75,
  "foot_length_m": 0.24,
...
[
  {
    ...
    "finished_measurements_m": {
      "back_length": 0.727,
      "chest_circumference": 1.1,
      "sleeve_from_center_back": 0.727,
...
{
  "barefoot": true,
  "internal_length_m": 0.252,
  "sole_height_m": 0,
  "construction": "足指5本、爪・足裏・踵の形状を作る。靴は含めない。",
  "color_and_type": "白い中厚空手着上下、白帯、不透明な白スポーツインナー、裸足",
  "forefoot_sole_m": 0,
  "heel_height_m": 0
}
```
...
|hair|#28201D|[0.25, 0.48]|0|黒髪を高めの束ね髪、若い成人の顔、引き締まった体格。束幅2–12mm、異方性、頭皮との境界を自然に。|
|top|#EBE9E2|[0.65, 0.85]|0|木綿織り、膝の張り、帯結びと縫合部を明瞭に。厚さと縫合はgarments表。|
|bottom|#EBE9E2|[0.65, 0.85]|0|織目は脚の長手方向。股下の縫い合わせ、ポケット口、裾折返しを別形状で作る。|
|accent|#E5E2D8|[0.6, 0.85]|0|帯/エプロン/インナー/配色。異なる生地は必要に応じてスロット分離。|
...
```json
{
  ...
  "description": "架空の日本人成人、21歳、裸足164cm。白い中厚空手着上下、白帯、不透明な白スポーツインナー、裸足。"
}
```
