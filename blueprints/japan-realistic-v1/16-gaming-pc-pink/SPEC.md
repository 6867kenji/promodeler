...
ピンクのゲーミングPC本体・27型フラットディスプレイ・75%キーボード・マウスの独立セット。透明側板、RGBファン、背面発光を備える。

ID: `gaming-pc-pink` / category: `pc-set` / kind: `prop` / status: `design_review`
...
|---|---|---|---|---|
|case-coat|#EAB8CB|[0.32, 0.48]|0|粉体塗装、板厚0.8mm。縁R1mm。ロゴなし。|
|shell-plastic|#EAB8CB|[0.35, 0.5]|0|モニター外装とマウス。同じ基調色で微細梨地。|
|keycap|#F0CBD9|[0.5, 0.7]|0|PBT風の梨地。主要キーと筐体で明度差をつける。|
|glass|#DDE5E7|[0.025, 0.06]|0|左側板4mm厚の透明ガラス、端R0.5mm。透過は追加実装対象。|
|dark-screen|#101822|[0.12, 0.22]|0|アンチグレア画面。画面に淡い抽象グラデーション、商標UIなし。|
|rgb-diffuser|#F5D6EA|[0.3, 0.45]|0|乳白拡散材。発光色は別チャンネルで制御。|
...
```json
{
  ...
  "description": "ピンクのゲーミングPC本体・27型フラットディスプレイ・75%キーボード・マウスの独立セット。透明側板、RGBファン、背面発光を備える。"
}
```
