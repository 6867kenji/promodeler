...
架空の日本人成人、62歳、裸足155cm。セージのカーディガン、生成りカットソー、紺のゆったりパンツ、ベージュの歩きやすい靴、小型トート。

ID `passerby-d` / category `female-character` / kind `humanoid` / 設計レビュー
...
```json
{
  ...
  "sex": "female",
  "age": 62,
  "face_shape_hair": "銀髪混じりのショートボブ、穏やかな丸顔、自然なしわ",
  "outfit_palette": "セージのカーディガン、生成りカットソー、紺のゆったりパンツ、ベージュの歩きやすい靴、小型トート"
}
```

## 外観

銀髪混じりのショートボブ、穏やかな丸顔、自然なしわ

## 身体寸法

```json
{
  "barefoot_height_m": 1.55,
  "standing_shod_height_m": 1.575,
  "shoe_sole_m": 0.025,
  "age": 62,
...
{
  "barefoot": false,
  "internal_length_m": 0.242,
  "sole_height_m": 0.025,
  "construction": "左右別。靴甲1.5mm、内張り1mm、紐径4mm。靴底の屈曲を足趾に追従。パンプスは踵高と足裏傾斜を別に調整。",
  "color_and_type": "セージのカーディガン、生成りカットソー、紺のゆったりパンツ、ベージュの歩きやすい靴、小型トート",
...
|hair|#D3D1C8|[0.25, 0.48]|0|銀髪混じりのショートボブ、穏やかな丸顔、自然なしわ。束幅2–12mm、異方性、頭皮との境界を自然に。 白髪比率は師範35%、通行人D65%、E90%を目標に束単位で混色。|
|top|#9BAE93|[0.65, 0.85]|0|ニットの毛羽、肌の自然な年齢差、袖口の弱い毛玉。厚さと縫合はgarments表。|
|bottom|#2D3A4B|[0.65, 0.85]|0|織目は脚の長手方向。股下の縫い合わせ、ポケット口、裾折返しを別形状で作る。|
|accent|#E1D6BF|[0.6, 0.85]|0|帯/エプロン/インナー/配色。異なる生地は必要に応じてスロット分離。|
...
```json
{
  ...
  "description": "架空の日本人成人、62歳、裸足155cm。セージのカーディガン、生成りカットソー、紺のゆったりパンツ、ベージュの歩きやすい靴、小型トート。"
}
```
