...
架空の日本人成人、52歳、裸足178cm。白い厚手空手着上下、黒帯、裸足、刺繍・流派ロゴなし。

ID `karate-master` / category `male-character` / kind `humanoid` / 設計レビュー
...
```json
{
  ...
  "sex": "male",
  "age": 52,
  "face_shape_hair": "短い塩胡椒髪、角張った顔、目尻のしわ、鍛えた体格",
  "outfit_palette": "白い厚手空手着上下、黒帯、裸足、刺繍・流派ロゴなし"
}
```

## 外観

短い塩胡椒髪、角張った顔、目尻のしわ、鍛えた体格

## 身体寸法

```json
{
  "barefoot_height_m": 1.78,
  "standing_shod_height_m": 1.78,
  "shoe_sole_m": 0,
  "age": 52,
  "shoulder_width_m": 0.47,
  "inseam_m": 0.81,
  "foot_length_m": 0.27,
...
[
  {
    ...
    "finished_measurements_m": {
      "back_length": 0.789,
      "chest_circumference": 1.28,
      "sleeve_from_center_back": 0.789,
...
{
  "barefoot": true,
  "internal_length_m": 0.282,
  "sole_height_m": 0,
  "construction": "足指5本、爪・足裏・踵の形状を作る。靴は含めない。",
  "color_and_type": "白い厚手空手着上下、黒帯、裸足、刺繍・流派ロゴなし",
  "forefoot_sole_m": 0,
  "heel_height_m": 0
}
```
...
|hair|#28201D|[0.25, 0.48]|0|短い塩胡椒髪、角張った顔、目尻のしわ、鍛えた体格。束幅2–12mm、異方性、頭皮との境界を自然に。 白髪比率は師範35%、通行人D65%、E90%を目標に束単位で混色。|
|top|#E7E5DE|[0.65, 0.85]|0|厚手木綿の織り、襟の多重縫製、袖口と帯端の適度な摩耗。厚さと縫合はgarments表。|
|bottom|#E7E5DE|[0.65, 0.85]|0|織目は脚の長手方向。股下の縫い合わせ、ポケット口、裾折返しを別形状で作る。|
|accent|#252729|[0.6, 0.85]|0|帯/エプロン/インナー/配色。異なる生地は必要に応じてスロット分離。|
...
```json
{
  ...
  "description": "架空の日本人成人、52歳、裸足178cm。白い厚手空手着上下、黒帯、裸足、刺繍・流派ロゴなし。"
}
```
