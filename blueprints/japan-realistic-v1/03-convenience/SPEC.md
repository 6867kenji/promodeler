...
- 棚とレジは取外し可能パーツ。レジは棚と平行な長辺と入口側の返しを持つL字型。奥の開放型冷蔵棚と中央棚の間、中央棚とレジの間は通路有効幅1.2m以上を確保。
- 中央入口はセンサー付き両開き自動スライドドア。通常時は0.9m、全開時は1.8mの開口を確保。

## パーツ分解

|ID|名称|中心XYZ（m）|サイズXYZ（m）|材質・備考|
|---|---|---|---|---|
|checkout|棚と平行なL字レジ台|[-5.8, 0.45, 2.825]|[3.6, 0.9, 4.05]|paint / 南北の長辺と入口側の返し|
|cold-wall|扉のない奥の冷蔵棚|[0, 1.05, -2.4]|[10.8, 2.1, 0.8]|metal / 正面から商品を直接取れる|
|right-cooler|右壁の扉付き冷蔵庫|[8.3, 1.125, 0.7]|[1.0, 2.25, 4.1]|metal / 売場側にガラス扉、壁から50mm|
|shelf-0|陳列棚|[-3, 0.75, 1.05]|[0.9, 1.5, 3.6]|paint / 棚板厚25mm、棚間隔300mm。商品は別サブアセット。|
|shelf-1|陳列棚|[0, 0.75, 1.05]|[0.9, 1.5, 3.6]|paint / 棚板厚25mm、棚間隔300mm。商品は別サブアセット。|
|shelf-2|陳列棚|[3, 0.75, 1.05]|[0.9, 1.5, 3.6]|paint / 棚板厚25mm、棚間隔300mm。商品は別サブアセット。|
...
|---|---|---|---|---|---|
|entry-left|slide|[-0.9, 0, 6]|[1, 0, 0]|[-0.45, 0] m|左へ0.45mスライドして開口を広げる。|
|entry-right|slide|[0.9, 0, 6]|[1, 0, 0]|[0, 0.45] m|右へ0.45mスライドして開口を広げる。|
|delivery|hinge|[6.5, 0, -6]|[0, 1, 0]|[0, 100] degree|搬入扉1.2×2.1m、外開き。|
|cooler|hinge|[7.8, 0, -1.35]|[0, 1, 0]|[-95, 0] degree|右壁の冷蔵庫扉。奥の冷蔵棚には扉を設けない。|
...
- [ ] 右壁の冷蔵庫扉を95度まで開いても棚と干渉しない。奥の冷蔵棚には扉がない。
- [ ] 入口から全棚を回れる連続経路を確保。
