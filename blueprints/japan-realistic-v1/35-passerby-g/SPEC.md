...
架空の日本人成人、39歳、裸足183cm。オリーブのオーバーシャツ、白Tシャツ、濃灰パンツ、黒スニーカー、小型黒メッセンジャーバッグ。

ID `passerby-g` / category `male-character` / kind `humanoid` / 設計レビュー
...
```json
{
  ...
  "sex": "male",
  "age": 39,
  "face_shape_hair": "黒の短いサイドパート、細い黒縁眼鏡、面長",
  "outfit_palette": "オリーブのオーバーシャツ、白Tシャツ、濃灰パンツ、黒スニーカー、小型黒メッセンジャーバッグ"
}
```

## 外観

黒の短いサイドパート、細い黒縁眼鏡、面長

## 身体寸法

```json
{
  "barefoot_height_m": 1.83,
  "standing_shod_height_m": 1.855,
  "shoe_sole_m": 0.025,
  "age": 39,
  "shoulder_width_m": 0.445,
  "inseam_m": 0.86,
  "foot_length_m": 0.275,
...
[
  {
    ...
    "finished_measurements_m": {
      ...
      "shoulder_width": 0.47000000000000003,
      "sleeve_length": 0.634
    },
...
{
  "barefoot": false,
  "internal_length_m": 0.287,
  "sole_height_m": 0.025,
  "construction": "左右別。靴甲1.5mm、内張り1mm、紐径4mm。靴底の屈曲を足趾に追従。パンプスは踵高と足裏傾斜を別に調整。",
  "color_and_type": "オリーブのオーバーシャツ、白Tシャツ、濃灰パンツ、黒スニーカー、小型黒メッセンジャーバッグ",
...
|hair|#28201D|[0.25, 0.48]|0|黒の短いサイドパート、細い黒縁眼鏡、面長。束幅2–12mm、異方性、頭皮との境界を自然に。|
|top|#737B60|[0.65, 0.85]|0|シャツの平織、眼鏡の細いヒンジ、バッグの補強縫い。厚さと縫合はgarments表。|
|bottom|#404348|[0.65, 0.85]|0|織目は脚の長手方向。股下の縫い合わせ、ポケット口、裾折返しを別形状で作る。|
|accent|#E5E4DF|[0.6, 0.85]|0|帯/エプロン/インナー/配色。異なる生地は必要に応じてスロット分離。|
...
```json
{
  ...
  "description": "架空の日本人成人、39歳、裸足183cm。オリーブのオーバーシャツ、白Tシャツ、濃灰パンツ、黒スニーカー、小型黒メッセンジャーバッグ。"
}
```
