...
架空の日本人成人、46歳、裸足170cm。青の半袖オックスフォードシャツ、ベージュチノパン、茶色のウォーキングシューズ、腕時計。

ID `passerby-c` / category `male-character` / kind `humanoid` / 設計レビュー
...
```json
{
  ...
  "sex": "male",
  "age": 46,
  "face_shape_hair": "短く刈った黒髪、幅広の顔、軽い腹部の丸み",
  "outfit_palette": "青の半袖オックスフォードシャツ、ベージュチノパン、茶色のウォーキングシューズ、腕時計"
}
```

## 外観

短く刈った黒髪、幅広の顔、軽い腹部の丸み
...
[
  {
    ...
    "finished_measurements_m": {
      "back_length": 0.73,
      "chest_circumference": 1.2600000000000002,
      "sleeve_length": 0.25
    },
    "construction": "腹部でボタンが食い込まない前身頃。ボタン径11mm、間隔85mm。",
    "deformation": "cloth"
  },
  {
    "id": "lower",
    ...
    "material": "bottom",
    "finished_measurements_m": {
      "waist_circumference": 1.07,
      "hip_circumference": 1.16,
      "inseam": 0.725,
...
{
  "barefoot": false,
  "internal_length_m": 0.277,
  "sole_height_m": 0.025,
  "construction": "左右別。靴甲1.5mm、内張り1mm、紐径4mm。靴底の屈曲を足趾に追従。パンプスは踵高と足裏傾斜を別に調整。",
  "color_and_type": "青の半袖オックスフォードシャツ、ベージュチノパン、茶色のウォーキングシューズ、腕時計",
...
|hair|#28201D|[0.25, 0.48]|0|短く刈った黒髪、幅広の顔、軽い腹部の丸み。束幅2–12mm、異方性、頭皮との境界を自然に。|
|top|#718DA7|[0.65, 0.85]|0|綿の交差織り、腹部と肘のしわ、靴甲の折れ。厚さと縫合はgarments表。|
|bottom|#B9A888|[0.65, 0.85]|0|織目は脚の長手方向。股下の縫い合わせ、ポケット口、裾折返しを別形状で作る。|
|accent|#714E39|[0.6, 0.85]|0|帯/エプロン/インナー/配色。異なる生地は必要に応じてスロット分離。|
...
```json
{
  ...
  "description": "架空の日本人成人、46歳、裸足170cm。青の半袖オックスフォードシャツ、ベージュチノパン、茶色のウォーキングシューズ、腕時計。"
}
```
