...
架空の日本人成人、35歳、裸足176cm。ネイビーのシングル2ボタンスーツ、白シャツ、深緑ネクタイ、黒革の紐靴、黒の薄型ブリーフケース。

ID `businessman` / category `male-character` / kind `humanoid` / 設計レビュー
...
```json
{
  ...
  "sex": "male",
  "age": 35,
  "face_shape_hair": "短い黒髪、左分け、面長、薄いひげ跡",
  "outfit_palette": "ネイビーのシングル2ボタンスーツ、白シャツ、深緑ネクタイ、黒革の紐靴、黒の薄型ブリーフケース"
}
```
...
```json
{
  "barefoot_height_m": 1.76,
  "standing_shod_height_m": 1.785,
  "shoe_sole_m": 0.025,
  "age": 35,
...
```json
{
  ...
  "color_and_type": "ネイビーのシングル2ボタンスーツ、白シャツ、深緑ネクタイ、黒革の紐靴、黒の薄型ブリーフケース",
...
|hair|#28201D|[0.25, 0.48]|0|短い黒髪、左分け、面長、薄いひげ跡。束幅2–12mm、異方性、頭皮との境界を自然に。|
|top|#243247|[0.65, 0.85]|0|紺のウール混綾織、肘と膝の軽い座りじわ、磨いた革靴。厚さと縫合はgarments表。|
|bottom|#243247|[0.65, 0.85]|0|織目は脚の長手方向。股下の縫い合わせ、ポケット口、裾折返しを別形状で作る。|
|accent|#244839|[0.6, 0.85]|0|帯/エプロン/インナー/配色。異なる生地は必要に応じてスロット分離。|
...
```json
{
  ...
  "description": "架空の日本人成人、35歳、裸足176cm。ネイビーのシングル2ボタンスーツ、白シャツ、深緑ネクタイ、黒革の紐靴、黒の薄型ブリーフケース。"
}
```
