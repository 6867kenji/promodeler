...
架空の日本人成人、28歳、裸足158cm。くすみピンクの薄手カーディガン、白Tシャツ、インディゴのストレートジーンズ、白スニーカー、生成りエコバッグ、スマートフォン。

ID `convenience-customer` / category `female-character` / kind `humanoid` / 設計レビュー
...
```json
{
  ...
  "sex": "female",
  "age": 28,
  "face_shape_hair": "栗色の肩丈髪を低いひとつ結び、丸い頬",
  "outfit_palette": "くすみピンクの薄手カーディガン、白Tシャツ、インディゴのストレートジーンズ、白スニーカー、生成りエコバッグ、スマートフォン"
}
```
...
```json
{
  "barefoot_height_m": 1.58,
  "standing_shod_height_m": 1.605,
  "shoe_sole_m": 0.025,
  "age": 28,
  "shoulder_width_m": 0.365,
  "inseam_m": 0.71,
  "foot_length_m": 0.23,
...
```json
{
  ...
  "color_and_type": "くすみピンクの薄手カーディガン、白Tシャツ、インディゴのストレートジーンズ、白スニーカー、生成りエコバッグ、スマートフォン",
...
|hair|#28201D|[0.25, 0.48]|0|栗色の肩丈髪を低いひとつ結び、丸い頬。束幅2–12mm、異方性、頭皮との境界を自然に。|
|top|#B98790|[0.65, 0.85]|0|ニット目0.8mm、デニム綾織、肘の軽い伸び。厚さと縫合はgarments表。|
|bottom|#293F58|[0.65, 0.85]|0|織目は脚の長手方向。股下の縫い合わせ、ポケット口、裾折返しを別形状で作る。|
|accent|#EEECE3|[0.6, 0.85]|0|帯/エプロン/インナー/配色。異なる生地は必要に応じてスロット分離。|
...
[
  ...
  },
  {
    ...
    "duration_s": 8,
    "loop": false,
    "description": "棚へ手を伸ばす、バッグへ商品を入れる。"
  }
]
```
...
```json
{
  ...
  "description": "架空の日本人成人、28歳、裸足158cm。くすみピンクの薄手カーディガン、白Tシャツ、インディゴのストレートジーンズ、白スニーカー、生成りエコバッグ、スマートフォン。"
}
```
